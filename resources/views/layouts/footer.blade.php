...
<div class="flex justify-center items-center h-32 border bg-white">
    <p class="font-semibold text-center text-base text-gray-7 leading-tight"><br>(c) sus inc.<br>お問い合わせ先: <a href="mailto:company@example.com">company@example.com</a></p>
</div>
